...
/* COLORFUL, STAR DUST POINTER TRAIL */
...
colours=new Array('#EC8248','#6AAB52','#F3F0EF','#E15F40','#ffa500','#F4C672','#A8CD65','#307263','#6C8CFC')
...
if (ie)
    document.write('<div id="con" style="z-index: 400; position:absolute;top:0px;left:0px"><div style="position:relative">');

if (ie||n6){
    for (i = 0; i < n; i++)
        document.write('<div id="dots'+i+'" style="z-index: 400; position:absolute;top:0px;left:0px;width:'+i/2+'px;height:'+i/2+'px;background:#ff0000;font-size:'+i/2+'"></div>');
}
...
function newColour() {
    ...
    c[2]=Math.floor(Math.random()*(256-c[1]/4));
    c.sort(function(){return (0.2 - Math.random());});
